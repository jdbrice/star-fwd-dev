...
echo docker run --rm -ti $@ -w /tmp/work -v `pwd`/work:/tmp/work -v `pwd`/star-sw:/tmp/star-sw-master jdbburg/star-sw-buil:v041820d bash
docker run --rm -ti $@ -w /tmp/work -v `pwd`/work:/tmp/work -v `pwd`/star-sw:/tmp/star-sw-master jdbburg/star-sw-build:v041820 bash 
